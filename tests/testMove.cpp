...
TEST(TestMove, TestMoveKnight) {
    Move move({0, 0}, {1, 2}, new Figure (Color::White, FigureType::Knight));
...
TEST(TestMove, TestMovePawn) {
    Move move({2, 2}, {3, 3}, new Figure(Color::White, FigureType::Pawn));
...
TEST(TestMove, TestMoveBishop) {
    Move move({4, 4}, {5, 5}, new Figure(Color::White, FigureType::Bishop));
...
TEST(TestMove, TestMoveRook) {
    Move move({6, 6}, {7, 7}, new Figure(Color::White, FigureType::Rook));
